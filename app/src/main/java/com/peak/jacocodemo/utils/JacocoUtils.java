package com.peak.jacocodemo.utils;

import android.os.Environment;
import android.util.Log;

import com.peak.jacocodemo.App;
...
public class JacocoUtils {
    ...
    //ec文件的路径
//    private static String DEFAULT_COVERAGE_FILE_PATH = "/mnt/sdcard/jacoco/coverage.ec";
        private static String DEFAULT_COVERAGE_FILE_PATH = Environment.getExternalStorageDirectory()+"/coverage.ec";

//    private static String DEFAULT_COVERAGE_FILE_PATH = App.context.getFilesDir().getPath().toString() + "/coverage.ec";
